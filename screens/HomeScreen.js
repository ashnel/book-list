      ...
      <ScrollView>
        <List>
          ...
          <ListItem
            ...
            subtitle={
              <View style={styles.subtitleView}>
                <Text style={styles.ratingText}>Kathy Sierra & Bert Bates</Text>
              </View>
            }
          />
          ...
          <ListItem
            title={<Text style={styles.title}>JavaScript: The Good Parts</Text>}
            subtitle={
              <View style={styles.subtitleView}>
          ...
          <ListItem
            title={<Text style={styles.title}>The Well-Grounded Rubyist</Text>}
            subtitle={
              <View style={styles.subtitleView}>
